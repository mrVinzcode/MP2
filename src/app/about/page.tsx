    ...
    <section className="text-gray-700 body-font">
      <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
        <div className="text-center lg:w-2/3 w-full">
          ...
          <p className="mb-8 indent-10 leading-relaxed text-justify  text-2xl md:text-xl">
            ...
            process but also offer insights into the cultural significance of
            each dish. More than just an app, their creation represents a fusion
            of cultures, a tribute to the culinary traditions of Korea that
